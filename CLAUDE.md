...
5. **Max 6 parallel agents per round** (Acta discipline). Translation agents: strict prompt per `feedback_acta-agent-prompt`; preserve inline markers from day 1; dedupe safety nets at assembly.
