...
<main class="essay">
  ...
  <article class="essay-body">
    ...
    <p>Use of the licensed material above to train, fine-tune, evaluate, or
    ground machine-learning systems, and to build retrieval indexes over
    it, is permitted &mdash; including for commercial model development.
    That is a deliberate carve-out from the "ask first" rule below: training
    or grounding a model, even a commercially offered one, is not treated
    as the kind of commercial use that requires asking. Keep the
    attribution, and say if you changed the text. Crawl it, index it, quote
    it. A bulk export is at <a href="/export/">/export</a> so crawling the
    site is not even necessary.</p>
