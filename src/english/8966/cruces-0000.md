...
| 1085A | ***Non** metuat de correctione inopiae, **quisquis** opes acquisivit sapientiae* | ***metuat*** | *quisquis* is the subject of the second clause, not a quantifier the negative can reach; the `enim` clause gives the reason for not fearing. |
...
| 1088A | *quia **nec** veterum patrum **nec** novorum dictis et exemplis potuerunt… revocari* | ***veterum patrum*** / ***novorum*** | the two `nec` are on the two ablative phrases, not on *potuerunt*: "neither by the sayings of the ancient fathers nor by those of the new", never "could not be recalled". |
